...
import { bhaktipasMenus } from "./data";
import DropdownCard from "@/components/DropDownCard";
import { isDropdownMenu } from "@/helper/utils";
import { Metadata } from "next";

export const metadata: Metadata = {
    title: "Hari Bhakti Pemasyarakatan",
};

export default function BhaktipasPage() {
    return (
            ...
            <header className="text-center mb-10">
                ...
                <div className="flex justify-center mb-4">
                    <div className="w-32 h-32 rounded-full overflow-hidden border border-white/20 bg-white/10 backdrop-blur-md">
                        <Image
                            src="/logo.png"
                            alt="Hari Bhakti Pemasyarakatan"
                            fill
                            priority
                ...
                <p className="text-white/70 text-sm mt-2">
                    Pelaporan Hari Bhakti Pemasyarakatan
                </p>
            </header>

            {/* ================= MENU ================= */}
            <section className="space-y-8">
                {bhaktipasMenus.map((group, i) => (
                    <div key={i}>
                        {/* Judul Kategori */}
